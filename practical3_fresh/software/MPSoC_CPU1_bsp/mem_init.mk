...
# Memory: onchip_cpu1
MEM_0 := MPSoC_onchip_cpu1
$(MEM_0)_NAME := onchip_cpu1
...
$(MEM_0)_HIERARCHICAL_PATH := onchip_cpu1
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: onchip_cpu1
onchip_cpu1: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
