...
# Memory: ram_stage1
MEM_0 := MPSoC_ram_stage1
$(MEM_0)_NAME := ram_stage1
...
$(MEM_0)_END := 0x080376ff
$(MEM_0)_HIERARCHICAL_PATH := ram_stage1
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: ram_stage1
ram_stage1: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: sdram_controller_stage1
MEM_1 := sdram_controller_stage1
$(MEM_1)_NAME := sdram_controller_stage1
...
$(MEM_1)_HIERARCHICAL_PATH := sdram_controller_stage1
$(MEM_1)_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: sdram_controller_stage1
sdram_controller_stage1: check_elf_exists $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
