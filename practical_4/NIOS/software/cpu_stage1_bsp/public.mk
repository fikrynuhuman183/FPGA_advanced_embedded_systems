...
SOPCINFO_FILE := C:/Users/DELL/Documents/advanced_embedded_systems/practical_4/NIOS/MPSoC.sopcinfo
...
# CPU Name 
# setting CPU_NAME is cpu_stage1
CPU_NAME = cpu_stage1
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x80410e8
SOPC_SYSID_FLAG += --sidp=0x80410e8
ELF_PATCH_FLAG  += --sidp 0x80410e8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1773046779
SOPC_SYSID_FLAG += --timestamp=1773046779
ELF_PATCH_FLAG  += --timestamp 1773046779
