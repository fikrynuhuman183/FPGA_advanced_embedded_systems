#! /home/isuru/xtensa/XtDevTools/install/tools/RD-2011.1-linux/XtensaTools/Tools/bin/perl
####################################################################################
...
BEGIN {@INC = map ({s'/usr/xtensa/tools-6.1'/home/isuru/xtensa/XtDevTools/install/tools/RD-2011.1-linux/XtensaTools/Tools'; $_} @INC); }
...
my $rc = 0;
my $topo = 0;
my $xdaDir = "/home/isuru/xtensa/XtDevTools/install/builds/RD-2011.1-linux/LX4_uclib_1/Hardware/xda";
my $pwd = cwd();
my $ret;
my $status;
...
-xda <dir>	Path to desired xda directory, which includes the edited
		...
		Defaults to /home/isuru/xtensa/XtDevTools/install/builds/RD-2011.1-linux/LX4_uclib_1/Hardware/xda.
...
my $RegfileArea = 0;
my ($AreaFile) = <portqueue3i1o.area>;
